 /* $Id: asm.y,v 1.64 2024/11/10 14:34:25 leavens Exp $ */
...
%type <number> number
%type <token> sign
%type <instr> twoRegNoOffsetsInstr
%type <token> twoRegNoOffsetsOp
...
instr : noArgInstr | twoRegCompInstr | twoRegNoOffsetsInstr
      | noTargetOffsetInstr | noSourceOffsetInstr | oneRegOffsetArgInstr
      | oneRegArgInstr | oneRegOffsetInstr | shiftInstr | argOnlyInstr
      | immedArithInstr | immedBoolInstr | branchTestInstr | jumpInstr
      | syscallInstr
      ;
...
twoRegNoOffsetsInstr : twoRegNoOffsetsOp regsym "," regsym
           {
	       $$ = ast_2reg_instr($1, $2.number, 0, $4.number, 0,
				   lexer_token2func($1.toknum));
	   }
           ;

twoRegNoOffsetsOp : "CPR" ;
