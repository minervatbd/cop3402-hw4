// $Id: instruction.h,v 1.40 2024/11/10 14:34:25 leavens Exp $
...
typedef enum {NOP_F = 0, ADD_F = 1, SUB_F = 2, CPW_F = 3, CPR_F = 4,
...
// but exit with an error if there is a problem.
extern void instruction_write_bin_instr(BOFFILE bf, bin_instr_t bi);
